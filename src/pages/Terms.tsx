      ...
      <main className="mx-auto max-w-3xl px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-muted-foreground">
          ...
          <section className="space-y-3">
            ...
            {/* B-3 fix (2026-05-09): aligned with Pricing + FAQ — subscription credits expire on the 28th of each month. */}
            <p>The Service operates on a credit-based system. Credits are consumed when generating content. Monthly subscription credits expire on the 28th of each month and do not roll over. Purchased credit packs (top-ups) do not expire but are non-refundable once consumed.</p>
