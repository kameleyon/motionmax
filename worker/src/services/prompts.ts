...
export const STYLE_PROMPTS: Record<string, string> = {
  ...
  realistic: `high contrast, high sharpness, high clarity, high shadow. Photorealistic Cinematic with sharp cinematic lighting, photography. 4K UHD, HDR, 8k resolution. Shot on 35mm lens with shallow depth of field (bokeh) to isolate subjects. Hyper-realistic textures, dramatic studio lighting with rim lights. Natural skin tones and accurate material physics. Look of high-end stock photography or a Netflix documentary. Sharp focus, rich contrast, and true-to-life color grading. Unreal Engine 5 render quality, like shot on Kodak Gold 400 film tones. All people in the scene should have beautiful features, with perfect body shapes, with luxury in the skin, eyes and hair.`,
  anime: `high contrast, high sharpness, high clarity, high shadow. Expressive Modern Manga-Style Sketchbook. An expressive modern manga-style sketchbook illustration. Anatomy: Large-eye expressive anime/manga influence focusing on high emotional impact and kawaii but relatable proportions. Line Work: Very loose, visible rough sketch lines—looks like a final drawing made over a messy pencil draft. Coloring: Natural tones with focus on skin-glow, painterly approach with visible thick brush strokes. Vibe: Cozy, chaotic, and sentimental slice-of-life moments. Features loose sketchy digital pencil lines and painterly slice-of-life aesthetic. High-detail facial expressions with large emotive eyes. Visible brush strokes. Set in detailed, slightly messy environment that feels lived-in. Cozy, relatable, and artistically sophisticated. All people in the scene should have beautiful features, with perfect body shapes, with luxury in the skin, eyes and hair.`,
  "3d": `high contrast, high sharpness, high clarity, high shadow. Premium feature-film 3D animation, clearly stylized and unmistakably animated, in the spirit of top-tier family animated cinema. Do NOT render photorealistic or live-action. Character Design: soft sculpted forms, elegant anatomy, slightly simplified facial structure, and large expressive eyes, while still preserving emotional realism and human dignity. Faces should feel beautifully designed, appealing, and deeply emotive, with subtle stylization rather than realism — refined nose, lips, brows, and cheekbones, soft but defined facial planes. Avoid caricature, comedy, or plastic toy-like appearance; bodies stylized but believable, elegant, and proportionate. Eyes: The Soul Focal Point—large, highly detailed eyes with realistic specular highlights, reflections, and deep iris colors making the character feel sentient and emotive. Material Science: luxurious subsurface scattering—that soft cinematic glow where light slightly penetrates the surface like real skin or wax—with natural tonal variation and smooth stylized realism. Fabric should feel tactile and dimensional with visible woven detail; environment surfaces should carry visible texture and material weight. Lighting Design: dramatic three-point cinematic lighting with a strong warm key light, soft fill to eliminate harsh shadows, and a bright rim light separating the subject from the background. Atmosphere: Volumetric Depth—light haze, dust motes, or god rays creating a sense of physical space—with shallow depth of field and soft background bokeh keeping focus on the subject. Rendering: ultra-clean cinematic render at 4K, razor-sharp subject detail, polished physically based shading, high dynamic range, and rich shadow separation. Warm Kodak Gold 400-inspired color tones, luminous highlights, rich amber light, and deep cinematic shadows. Masterpiece quality—tactile, charming, highly emotive, and visually expensive. Make every frame feel like a still from a major animated feature film. All people in the scene should have beautiful features, with perfect body shapes, with luxury in the skin, eyes and hair.`,
  claymation: `high contrast, high sharpness, high clarity, high shadow. Cinematic with sharp cinematic lighting, shot on Kodak Gold 400 film tones, Handcrafted Digital Clay. A high-detail 3D claymation-style render. Material Texture: Matte & Tactile—surfaces must show subtle, realistic imperfections like tiny thumbprints, slight molding creases, and a soft matte finish that mimics polymer clay (like Sculpey or Fimo). Lighting: Miniature Macro Lighting—soft, high-contrast studio lighting that makes the subject look like a small physical object, includes Rim Lighting to make the edges glow and deep, soft-edge shadows. Proportions: Chunky & Appealing—thick, rounded limbs and exaggerated squashy features, avoid any sharp digital edges, everything should look like it was rolled between two palms. Atmosphere: Depth of Field—heavy background blur (bokeh) essential to sell the small toy scale, making the subject pop as the central focus. Color Palette: Saturated & Playful—bold, solid primary colors that look like they came straight out of a clay pack, avoiding complex gradients. 8k resolution, Octane Render, masterpiece quality. All people in the scene should have beautiful features, with perfect body shapes, with luxury in the skin, eyes and hair.`,
  ...
  caricature: `high contrast, high sharpness, high clarity, high shadow. Humorous caricature illustration inspired by the visual aesthetic of MAD Magazine cover art — bold, dynamic, richly painted with energetic brushwork. Highly exaggerated facial features: oversized heads, giant expressive eyes, huge noses, rubbery lips, tiny bodies. Vivid, saturated color palette with loose oil-painting brushstrokes and strong ink outlines. Characters are dramatic, larger-than-life, and bursting with personality. Dynamic cinematic compositions with expressive poses and exaggerated reactions. The painterly style has visible confident brushwork, vibrant shadows, and punchy highlights. All people in the scene should have beautiful features, with perfect body shapes, with luxury in the skin, eyes and hair. CRITICAL: Do NOT include the MAD magazine logo or title text anywhere in the image. No "MAD" lettering, no magazine masthead, no title banner.`,
  moody: `Cinematic, 3D, High definition, dark background and enviroment, dark eyes, with sharp directional lighting, Moody monochrome indie comic illustration in black, white, and grays. High sharpness, high clarity, high shadow, 3D ink-drawn storybook panel with strong depth cues: layered foreground, midground, and background; subtle atmospheric perspective; visible cast shadows; occlusion between objects; rim lighting around the main subject; and slightly exaggerated perspective to make the scene feel dimensional without becoming photorealistic. Thick clean outlines with hand-inked crosshatching, scratchy pen texture, and sculpted tonal shading that wraps around forms.Slightly uneven line quality like traditional ink on paper. Cute-but-unsettling character design: oversized head, huge simple empty black eyes, tiny mouth, minimal to no nose, small body with simplified hands. Cinematic centered framing, quiet tension, lots of flat mid-gray tones balanced with deeper blacks in the foreground and softer faded grays in the distance. Subtle paper grain, faint smudges, edge vignetting, and ink flecks. Background is minimal but grounded with simple interior props drawn in the same inked style, arranged in layers to create spatial depth. Overall vibe: moody, not happy, melancholic, eerie, storybook graphic novel panel, high contrast, no color. Hand-drawn 3D ink illustration, not CGI, not photorealistic. NEGATIVE PROMPT: Do NOT invent or describe any human character's race, ethnicity, hair, age, gender, clothing, or facial features. no plastic look, no photorealism, no bright colors, no anime polish, no smooth digital airbrush.`,
  storybook: `high contrast, high sharpness, high clarity, high shadow. Cinematic with sharp cinematic lighting, shot on Kodak Gold 400 film tones, 2.5D / subtle 3D PaperCut rough sketchy storybook hand-drawn ink style. Layered paper-cut depth with visible separation between foreground, midground, and background. Slight sculptural volume on faces, hair, clothing, props, and animals, with soft cast shadows, rim lighting, occlusion, and dimensional shading that makes the scene feel tactile and raised from the page without becoming photorealistic. Hand-drawn black ink outlines with visible rough sketch construction lines, slightly uneven strokes, and occasional line overlap, imperfect but intentional. Bold vivid natural color palette. Crosshatching and scribbly pen shading for depth and texture, especially in shadows, hair, fabric folds, and textured surfaces. Edges slightly loose, not crisp. Cartoon-proportioned character design with slightly exaggerated features, large expressive eyes, long limbs, expressive faces, and slightly oversized heads, but grounded in believable anatomy and posture. Faces and bodies should have elegant stylized beauty, polished proportions, luminous skin, expressive eyes, and richly detailed hair. Background extremely detailed with textured walls, layered props, atmospheric depth, visible cast shadows, and shallow depth cues. Soft focus in the far background, stronger clarity in the foreground. Subtle grain, ink flecks, and handmade print texture. Charming, cozy, slightly messy, richly textured, cinematic framing, high detail, UHD. No photorealism, no flat vector, no plastic 3D render, no overly smooth AI polish.`,
  ...
  lego: `high contrast, high sharpness, high clarity, high shadow. Cinematic with sharp cinematic lighting, shot on Kodak Gold 400 film tones, A hyper-realistic, macro-photography 3D CGI render of a Lego diorama. Extreme close-up, low-angle dynamic perspective. The entire scene is built of recognizable, glossy injection-molded plastic Lego bricks with prominent studs. Characters are in rigid but epic, dynamic poses. Emphasize macro micro-details: subtle surface scratches, fingerprints, and edge highlights on the plastic. Intense cinematic rim lighting, heavy shadows, high contrast, and volumetric glowing particle effects (fire embers and lightning sparks). Extreme shallow depth of field with heavy, cinematic background bokeh completely blurring the stadium crowd. The lighting is stylized and dramatic, resembling a high-end, high quality, intrisinctly detailed, official Lego movie close-up. All people in the scene should have beautiful features, with perfect body shapes, with luxury in the skin, eyes and hair.`,
  cardboard: `high contrast, high sharpness, high clarity, high shadow. Cinematic with sharp cinematic lighting, shot on Kodak Gold 400 film tones, A high-quality, highly dynamic visualization social media explainer video still featuring a tabletop miniature diorama. The scene is populated by very detailed, expressive claymation-style figurines representing a diverse group of people based on the content context. The figures must meet distinct, clearly defined ethnic features based on the content context, when it comes to skin tones, and highly textured matching specific cultural hairstyles. It is detailed, high contrast, high resolution, high definition, They are dressed in carefully crafted miniature clothing and in the content cultural context. The environment, structures, and props are constructed from clean, precise corrugated cardboard, kraft paper, alluminum foil and light wood, utilizing thin visible wires or strings to suspend floating elements. Bold, black, physical 3D text and symbolic graphic props (like arrows, charts, or currency signs) are integrated directly into the physical space as tangible objects. Set against a bright, pristine white seamless studio background with soft, realistic tabletop shadows. The overall aesthetic is a premium, professional tactile miniature world, blending expressive, detailed clay characters with crisp, organized papercraft environments. All people in the scene should have beautiful features, with perfect body shapes, with luxury in the skin, eyes and hair.`,
  barbie: `high contrast, high sharpness, high clarity, high shadow. Cinematic with sharp cinematic lighting, shot on Kodak Gold 400 film tones, Hyper-realistic Barbie-style fashion doll with overexagerated sarcastic emotinal expression on her face, not completely fitting the situation. She looks like a real premium Barbie doll: glossy smooth plastic skin, sculpted glamorous face, rooted hair, dramatic lashes, glassy eyes, polished makeup, and high-end doll realism. Expression: highly exaggerated and meme-like, but still controlled and elegant. A visual representation of what people call unhinged nowaday. Think classic Barbie meme face: overexpressive, absurdly readable, and dramatic without looking angry. The emotion should feel sarcastic, stunned, judgmental, unimpressed, and theatrically expressive. Her posture unhinged, cinematic lighting, volumetric lighting, UHD, HDR, Highly Dynamic, 64k, high contrast. All people in the scene should have beautiful features, with perfect body shapes, with luxury in the skin, eyes and hair. NEGATIVE PROMPT: seamless premium fashion-doll bodies with no visible articulation. No ball joints, no elbow hinges, no knee joints, no wrist seams, no segmented limbs, no action-figure construction`,
  miniworld: `high contrast, high sharpness, high clarity, high shadow. hyper-detailed miniature world animation, tiny people interacting with giant everyday objects, macro lens, shallow depth of field, tactile textures, whimsical realism. All people in the scene should have beautiful features, with perfect body shapes, with luxury in the skin, eyes and hair.`,
  collage: `high contrast, high sharpness, high clarity, high shadow. surreal animated collage, vintage magazine cutouts, paper scraps, old photographs, torn edges, stop-motion movement, absurd symbolic composition, eerie documentary mood. All people in the scene should have beautiful features, with perfect body shapes, with luxury in the skin, eyes and hair.`,
};
...
/** Prepended to every style prompt — frames all generated imagery as
 *  caricature so the image model treats real people, places, and names
 *  as stylized (non-literal) representation. */
const CARICATURE_DISCLAIMER =
  "IT'S A CARICATURE NOT REAL REPRESENTATION OF THE PEOPLE, PLACE, OR NAME USE";
 ...
 *  stylized environment. Every returned prompt leads with
 *  CARICATURE_DISCLAIMER. */
export function getStylePrompt(style: string, customStyle?: string, projectType?: string): string {
  if (style === "custom" && customStyle) {
    // Custom user-supplied prompt: trust the user for the style body —
    // no suffix, no nanny — but still lead with the caricature
    // disclaimer so the framing is consistent across every style.
    return `${CARICATURE_DISCLAIMER}. ${customStyle}`;
  }
  ...
  const styled = isRealisticStyle(key) ? base : base + STYLE_INTEGRITY_SUFFIX;
  return `${CARICATURE_DISCLAIMER}. ${styled}`;
}
