...
export function AppHeader({ actions, className }: AppHeaderProps) {
  return (
    ...
    >
      ...
      {/* (former centered teal pill removed — replaced by the
          full-width gold strip rendered above the header by
          BetaRebuildBanner. The strip is unmissable; an additional
          centered pill would just compete with it.) */}
