...
function providerForId(id: string): CatalogVoice["provider"] {
  ...
  if (id === "Zuri" || id === "Morpheus" || id === "Jacynthe" || id === "Phoebe" || id === "Eddy" || id === "Mario" || id === "Misko" || id === "Robert" || id === "Miriam" || id === "Roselie" || id === "Emily" || id === "Melanie" || id === "Tatiana" || id === "Micha" || id === "Ludovic" || id === "Richard" || id === "William" || id === "Claudel") return "fish";
  return "gemini";
}
