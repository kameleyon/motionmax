-- Consolidates all RLS policies into migration lineage.
-- Previously applied ad-hoc via scripts/apply-rls-policies.mjs.
-- Each policy is dropped first to make this migration idempotent.
...
DROP POLICY IF EXISTS "api_keys_insert" ON public.user_api_keys;
DROP POLICY IF EXISTS "api_keys_update" ON public.user_api_keys;
DROP POLICY IF EXISTS "api_keys_delete" ON public.user_api_keys;
DROP POLICY IF EXISTS "api_keys_deny_anon" ON public.user_api_keys;
...
DROP POLICY IF EXISTS "subs_deny_insert" ON public.subscriptions;
DROP POLICY IF EXISTS "subs_deny_update" ON public.subscriptions;
DROP POLICY IF EXISTS "subs_deny_anon" ON public.subscriptions;
...
-- ── user_credits ──
DROP POLICY IF EXISTS "credits_select" ON public.user_credits;
DROP POLICY IF EXISTS "credits_sr_insert" ON public.user_credits;
DROP POLICY IF EXISTS "credits_sr_update" ON public.user_credits;
DROP POLICY IF EXISTS "credits_sr_delete" ON public.user_credits;
DROP POLICY IF EXISTS "credits_deny_auth_insert" ON public.user_credits;
DROP POLICY IF EXISTS "credits_deny_auth_update" ON public.user_credits;
DROP POLICY IF EXISTS "credits_deny_auth_delete" ON public.user_credits;
DROP POLICY IF EXISTS "credits_deny_anon" ON public.user_credits;
...
DROP POLICY IF EXISTS "credit_tx_deny_insert" ON public.credit_transactions;
DROP POLICY IF EXISTS "credit_tx_deny_anon" ON public.credit_transactions;
...
-- ── generations ──
DROP POLICY IF EXISTS "gens_select" ON public.generations;
DROP POLICY IF EXISTS "gens_insert" ON public.generations;
DROP POLICY IF EXISTS "gens_update" ON public.generations;
DROP POLICY IF EXISTS "gens_delete" ON public.generations;
...
-- ── generation_archives ──
DROP POLICY IF EXISTS "archives_select" ON public.generation_archives;
DROP POLICY IF EXISTS "archives_deny_anon" ON public.generation_archives;
...
-- ── generation_costs ──
DROP POLICY IF EXISTS "gen_costs_select" ON public.generation_costs;
DROP POLICY IF EXISTS "gen_costs_sr_insert" ON public.generation_costs;
DROP POLICY IF EXISTS "gen_costs_deny_anon" ON public.generation_costs;
...
-- ── api_call_logs ──
DROP POLICY IF EXISTS "api_logs_select" ON public.api_call_logs;
DROP POLICY IF EXISTS "api_logs_sr_insert" ON public.api_call_logs;
DROP POLICY IF EXISTS "api_logs_deny_anon" ON public.api_call_logs;
...
-- ── system_logs ──
DROP POLICY IF EXISTS "sys_logs_select" ON public.system_logs;
DROP POLICY IF EXISTS "sys_logs_deny_anon_select" ON public.system_logs;
DROP POLICY IF EXISTS "sys_logs_deny_anon_insert" ON public.system_logs;
DROP POLICY IF EXISTS "sys_logs_deny_anon_update" ON public.system_logs;
DROP POLICY IF EXISTS "sys_logs_deny_anon_delete" ON public.system_logs;
...
-- ── project_characters ──
DROP POLICY IF EXISTS "chars_select" ON public.project_characters;
DROP POLICY IF EXISTS "chars_insert" ON public.project_characters;
DROP POLICY IF EXISTS "chars_update" ON public.project_characters;
DROP POLICY IF EXISTS "chars_delete" ON public.project_characters;
DROP POLICY IF EXISTS "chars_deny_anon" ON public.project_characters;
...
-- ── user_voices ──
DROP POLICY IF EXISTS "voices_select" ON public.user_voices;
DROP POLICY IF EXISTS "voices_insert" ON public.user_voices;
DROP POLICY IF EXISTS "voices_update" ON public.user_voices;
DROP POLICY IF EXISTS "voices_delete" ON public.user_voices;
...
DROP POLICY IF EXISTS "roles_deny_anon" ON public.user_roles;
...
-- ── user_flags ──
DROP POLICY IF EXISTS "flags_select" ON public.user_flags;
DROP POLICY IF EXISTS "flags_insert" ON public.user_flags;
DROP POLICY IF EXISTS "flags_update" ON public.user_flags;
DROP POLICY IF EXISTS "flags_delete" ON public.user_flags;
DROP POLICY IF EXISTS "flags_deny_anon" ON public.user_flags;
