        ...
        <div className="row">
          <div>
            <div className="meta">
              ...
              <span>·</span>
              <span style={{ whiteSpace: "nowrap" }}>{planLabel}{o?.paused_until ? " · Paused" : ""}</span>
              <span>·</span>
              <span style={{ whiteSpace: "nowrap" }}>{o?.paused_until ? `Paused until ${shortDate(o.paused_until)}` : "Auto renew"}</span>
            </div>
